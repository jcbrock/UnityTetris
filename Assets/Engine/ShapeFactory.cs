...
namespace AssemblyCSharp
{
		...
		public class ShapeFactory
		{
				...
				public Shape SpawnRandomizedTetrisShape (int rulesetOption)
				{
						...
						//spawn
						Shape newShape = new Shape (SpawnNewBlock (randomShapeToGenerate.CompositeGameObject, previewPosition), randomShapeToGenerate.RotationStyle, xStart);
